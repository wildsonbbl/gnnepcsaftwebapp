...
On [releases](https://github.com/wildsonbbl/gnnepcsaftwebapp/releases), you find a desktop app. A container image is also available on [Docker Hub](https://hub.docker.com/r/wildsonbbl/gnnpcsaftwebapp), and can be run using:
